    ...
    return (
        <View className="flex-1 bg-black-800 pt-16">
            <KeyboardAvoidingView 
                ...
                <View className="flex flex-row justify-center items-center gap-4 px-8 bg-black-900">
                    <TextInput
                        placeholder='O que você quer ouvir?'
                        value = {search}
                        onChangeText={(e) => setSearch(e)}
                        onSubmitEditing={() => finishSearch()}
                        className="w-4/5 h-10 bg-black-50 p-2 rounded"
                        />
                ...
                <ScrollView className="px-8 mb-40 pb-20 overflow-visible">
